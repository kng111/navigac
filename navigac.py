...
def start(update: Update, context: CallbackContext):
    schedule_text = """ 👾:Вас приветствует навигационнный телеграмм бот Физтеха\n
      Для ознакомления функционала бота советуем воспользоваться /zvonki для ознакомления с расписанием и звонками\n
      и /helpkab для навигации по колледжу ( с помощью команд /kab [номер кабинета])
      """
